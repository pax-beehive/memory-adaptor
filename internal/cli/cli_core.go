...
func (r runner) printHelp() {
	...
	_, _ = fmt.Fprintln(r.stdout, "  paxm [--config PATH] setup [--user-id ID] [--team-id ID] [--integration paxm|codex-plugin|claude-plugin]")
	...
	_, _ = fmt.Fprintln(r.stdout, "  paxm [--config PATH] mcp serve [--agent AGENT]")
